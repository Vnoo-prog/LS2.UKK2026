...
<body onload="window.print()">
    ...
    <div class="header">
        ...
        <?php if(request('tgl_awal') && request('tgl_akhir')): ?>
            <p><strong>Periode:</strong> <?php echo e(request('tgl_awal')); ?> s/d <?php echo e(request('tgl_akhir')); ?></p>
        <?php else: ?>
    ...
    <table>
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $peminjamans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
                <td class="text-center"><?php echo e($index + 1); ?></td>
                <td><?php echo e($p->user->nama_lengkap); ?></td>
                <td><?php echo e($p->buku->judul); ?></td>
                <td class="text-center"><?php echo e($p->tanggal_peminjaman); ?></td>
                <td class="text-center"><?php echo e($p->tanggal_pengembalian); ?></td>
                <td class="text-center"><?php echo e($p->status_peminjaman); ?></td>
            </tr>
    ...
    <div style="margin-top: 40px; width: 100%; text-align: right;">
        ...
        <p><strong><?php echo e(Auth::user()->nama_lengkap); ?></strong></p>
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\Dipus\resources\views/laporan/cetak.blade.php ENDPATH**/ ?>